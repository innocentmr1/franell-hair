    ...
    <div className="shipping-page">
      ...
      <div className="faq-body">
        ...
        <div className="shipping-cards">
          {[
            { icon: <Truck size={28} />, title: 'Standard Shipping', detail: '5–7 business days', note: 'Free on orders over $150 · $8.99 flat fee otherwise' },
            { icon: <Clock size={28} />, title: 'Express Shipping', detail: '2–3 business days', note: 'Calculated at checkout based on location' },
        ...
        <section className="shipping-section">
          ...
          <div className="shipping-prose">
            ...
            <p>Currently, we ship to addresses within the United States only. We are working on international shipping and will announce when it's available.</p>
            ...
            <p>If your package is lost or arrives damaged, please contact us within 7 days of the expected delivery date at <a href="mailto:info@franellhair.com">info@franellhair.com</a> and we will resolve it promptly.</p>
          </div>
        </section>
        ...
        <section className="shipping-section">
          ...
          <div className="shipping-prose">
            ...
            <p>We want you to love your Franell Hair purchase. If you are not completely satisfied, you may return eligible items within <strong>30 days</strong> of delivery for a full refund or exchange.</p>
            ...
            <ol>
              ...
              <li>Pack the item securely in its original packaging and drop it off at any UPS location</li>
              <li>Once we receive and inspect the item, your refund will be processed within 3–5 business days</li>
            </ol>

            <h3>Exchanges</h3>
            <p>Want a different length, texture, or colour? We're happy to exchange any eligible item. Email us within 30 days of delivery and we'll arrange the swap at no extra cost.</p>
          </div>
        </section>
